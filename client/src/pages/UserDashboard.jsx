      ...
      <div className="max-w-2xl mx-auto space-y-4">
        ...
        <div className="card bg-base-100 shadow-xl">
          <div className="card-body items-center text-center gap-3">
            ...
            >
              <div className="size-24 rounded-full bg-primary text-primary-content text-3xl font-extrabold flex items-center justify-center overflow-hidden ring ring-primary ring-offset-base-100 ring-offset-2">
                {uploadingPhoto ? (
